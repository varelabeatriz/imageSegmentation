...
for (int y=0; y < img.height; y++){
  ...
  int jan = 2, qtde=-2; //referente a janela do pixel, dois pra cima e dois pra baixo
  float media =0;
...
for (int y=0; y < img.height; y++){ //linha pra percorrer a imagem
  ...
  if
    (blue(aux.pixels[pos]) > 120 && y<515) aux.pixels[pos] = color(255);
